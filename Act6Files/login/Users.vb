...
Public Class Users
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Dim strsql As String = "INSERT INTO users VALUES('" & Me.txtid.Text & "','" & Me.txtusername.Text & "','" & Me.txtpassword.Text & "' )"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Dim strsql As String = "UPDATE users SET username = '" & Me.txtusername.Text & "', password = '" & Me.txtpassword.Text & "' WHERE id = " & Me.txtid.Text
        Connect_to_DB()
        Dim myCommand As New MySqlCommand
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Dim strsql As String = "delete from users where id = '" & Me.txtid.Text & "'"
    ...
    Private Sub btnBackup_Click(sender As Object, e As EventArgs) Handles btnBackup.Click
        Try
            If Not String.IsNullOrEmpty(csvFilePath) Then
                ...
                Dim backupFilePath As String = Path.Combine(Path.GetDirectoryName(csvFilePath), "UsersBackup.bat")
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            exlFile.Workbooks.Open("C:\Users\Mark Louie Manrique\source\repos\DSM\template\Users-File.xlsx")
            ...
            Dim filename As String = "UsersRecord_" & DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") & ".xlsx"
