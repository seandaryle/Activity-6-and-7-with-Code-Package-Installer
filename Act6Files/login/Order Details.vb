...
Public Class orderdetails
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Dim strsql As String = "INSERT INTO orderdetails VALUES('" & Me.txtorderID.Text & "','" & Me.txtOrdersID.Text & "','" & Me.txtproductnames.Text & "','" & Me.txtquantity.Text & "' )"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Dim strsql As String = "UPDATE orderdetails SET orderID = '" & Me.txtOrdersID.Text & "', productName = '" & Me.txtproductnames.Text & "', Quantity = '" & Me.txtquantity.Text & "' WHERE orderDetailsID = " & Me.txtorderID.Text
        Connect_to_DB()
        Dim myCommand As New MySqlCommand
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Dim strsql As String = "delete from orderdetails where orderID = '" & Me.txtOrdersID.Text & "'"
    ...
    Private Sub btnBackup_Click(sender As Object, e As EventArgs) Handles btnBackup.Click
        Try
            If Not String.IsNullOrEmpty(csvFilePath) Then
                ...
                Dim backupFilePath As String = Path.Combine(Path.GetDirectoryName(csvFilePath), "DetailsBackup.bat")
                File.Copy(csvFilePath, backupFilePath, True)

                MessageBox.Show("Backed up successfully!")
            Else
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            exlFile.Workbooks.Open("C:\Users\Mark Louie Manrique\source\repos\DSM\template\Order-Details-File.xlsx")
            ...
            Dim filename As String = "DetailsRecord_" & DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") & ".xlsx"
    ...
    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        Dim DBConnectionString As String = "server=localhost;user id=root; port=3306; password=admin; database=fatdatabase"
        Dim strsql As String = "SELECT * FROM orderdetails"
