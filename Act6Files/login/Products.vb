...
Public Class products
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Dim strsql As String = "INSERT INTO products VALUES('" & Me.txtproductID.Text & "','" & Me.txtproductName.Text & "','" & Me.txtprice.Text & "','" & Me.txtqualitySold.Text & "','" & Me.txtbuyers.Text & "' )"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Dim strsql As String = "UPDATE products SET product_name = '" & Me.txtproductName.Text & "', Price = '" & Me.txtprice.Text & "', Quality_sold = '" & Me.txtqualitySold.Text & "', buyers = '" & Me.txtbuyers.Text & "' WHERE product_id = " & Me.txtproductID.Text
        Connect_to_DB()
        Dim myCommand As New MySqlCommand
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Dim strsql As String = "delete from products where product_id = '" & Me.txtproductID.Text & "'"
    ...
    Private Sub btnBackup_Click(sender As Object, e As EventArgs) Handles btnBackup.Click
        Try
            If Not String.IsNullOrEmpty(csvFilePath) Then
                ...
                Dim backupFilePath As String = Path.Combine(Path.GetDirectoryName(csvFilePath), "ProductsBackup.bat")
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            exlFile.Workbooks.Open("C:\Users\Mark Louie Manrique\source\repos\DSM\template\Products-File.xlsx")
            ...
            Dim filename As String = "ProductsRecord_" & DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") & ".xlsx"
